...
{q:"Alan Turing merupakan tokoh penting dalam sejarah AI. Kontribusinya yang paling terkenal adalah...",o:["Menciptakan GAN","Mengusulkan Turing Test sebagai cara menguji kecerdasan mesin","Mengembangkan Photoshop","Menemukan Diffusion Model"],a:1},
{q:"Turing Test adalah pengujian untuk menentukan apakah...",o:["Mesin mampu menyimpan data dalam jumlah besar","Mesin dapat berpikir seperti manusia melalui percakapan yang tidak dapat dibedakan dari manusia","Komputer mampu mengolah angka lebih cepat dari manusia","Mesin bisa mencetak dokumen secara otomatis"],a:1},
{q:"Sebutan 'Bapak Kecerdasan Buatan' biasanya ditujukan kepada tokoh yang memperkenalkan istilah Artificial Intelligence pada Konferensi Dartmouth, yaitu...",o:["Alan Turing","John McCarthy","Ian Goodfellow","Geoffrey Hinton"],a:1},
{q:"Machine Learning merupakan cabang AI yang memungkinkan mesin...",o:["Belajar dari data untuk meningkatkan kemampuannya tanpa diprogram ulang secara eksplisit","Bekerja hanya dengan aturan if-then yang tetap","Menggantikan jaringan internet","Menghapus data secara otomatis"],a:0},
{q:"Deep Learning adalah bagian dari Machine Learning yang memproses data menggunakan...",o:["Tabel database sederhana","Jaringan saraf tiruan (neural network) berlapis banyak","Perintah kalkulator manual","Aturan gramatikal bahasa"],a:1},
{q:"Urutan hubungan yang benar antara AI, Machine Learning, dan Deep Learning adalah...",o:["Deep Learning ⊂ Machine Learning ⊂ AI","AI ⊂ Machine Learning ⊂ Deep Learning","Machine Learning ⊂ AI ⊂ Deep Learning","Ketiganya tidak saling berhubungan"],a:0},
{q:"Perbedaan mendasar antara AI Konvensional dan AI Generatif terletak pada...",o:["Jenis monitor yang digunakan","Kemampuan menghasilkan konten baru yang belum pernah ada","Jumlah tombol pada antarmuka","Kecepatan internet yang dibutuhkan"],a:1},
{q:"Chatbot rule-based tergolong AI Konvensional karena...",o:["Menghasilkan teks baru secara kreatif","Menjalankan jawaban berdasarkan aturan/percabangan yang telah ditentukan","Menggunakan diffusion model","Belajar sendiri tanpa aturan"],a:1},
{q:"Contoh AI generatif yang fokus menghasilkan teks adalah...",o:["Large Language Model (LLM) seperti ChatGPT","Sistem pakar diagnostik","Kalkulator ilmiah","Aplikasi pengolah kata offline"],a:0},
{q:"Pada model text-to-image seperti Stable Diffusion, input utama yang diberikan pengguna berupa...",o:["Suara rekaman","Prompt berupa teks deskripsi","Video berdurasi panjang","Gambar foto tanpa keterangan"],a:1,img:"diffusion"},
{q:"Pada proses training Diffusion Model, tujuan tahap forward diffusion adalah...",o:["Mengembalikan gambar dari noise","Mempelajari cara menambahkan noise secara bertahap dari data gambar","Mengubah suara menjadi gambar","Menghapus seluruh data pelatihan"],a:1,img:"diffusion"},
{q:"Embedding pada AI generatif adalah...",o:["Bingkai tampilan aplikasi","Representasi numerik (vektor angka) dari teks sehingga dapat dipahami model","Tombol unduh gambar","File penyimpanan sementara"],a:1,img:"prompt"},
{q:"Keunggulan Diffusion Model dalam menghasilkan gambar adalah...",o:["Tidak memerlukan prompt","Kemampuannya menghasilkan detail gambar yang tajam dan realistis","Hanya menghasilkan teks","Tidak memerlukan komputasi"],a:1,img:"diffusion"},
{q:"Komponen dalam arsitektur Diffusion Model yang bertugas mengubah prompt menjadi embedding adalah...",o:["Generator","Discriminator","Text encoder","Noise predictor"],a:2,img:"prompt"},
{q:"Hasil keluaran (output) dari Generator pada GAN berupa...",o:["Data asli dari dataset","Gambar palsu (fake) yang menyerupai gambar asli","Label klasifikasi angka","Suara hasil rekaman"],a:1,img:"gan"},
{q:"Data gambar asli (real dataset) pada GAN digunakan untuk...",o:["Melatih Discriminator agar dapat membedakan gambar asli dan palsu","Menghapus gambar palsu","Mengubah prompt menjadi suara","Mempercepat koneksi internet"],a:0,img:"gan"},
{q:"Berikut ini yang merupakan contoh penerapan GAN dalam kehidupan nyata adalah...",o:["Deepfake dan super resolution gambar","Mesin fotokopi biasa","Kalkulator grafik","Pemutar musik"],a:0,img:"gan"},
{q:"Salah satu kelemahan GAN adalah sulit dilatih dan berisiko mengalami...",o:["Mode collapse (generator hanya menghasilkan variasi gambar yang sedikit/monoton)","Kehabisan memori kamera","Overheating printer","Koneksi WiFi terputus"],a:0},
{q:"Adobe Firefly menonjol dibandingkan platform AI generatif lain karena...",o:["Berjalan tanpa listrik","Terintegrasi langsung dengan aplikasi Adobe seperti Photoshop","Tidak memerlukan prompt","Hanya untuk membuat spreadsheet"],a:1,img:"platforms"}
  ]
};
